...
F5XC_TENANT=your-tenant-id
F5XC_EMAIL=you@example.com

# Application
F5XC_NAMESPACE=your-namespace
F5XC_LB_NAME=your-lb-name
F5XC_DOMAINNAME=app.yourdomain.com
F5XC_ROOT_DOMAIN=yourdomain.com

# Origin Configuration
F5XC_ORIGIN_POOL=your-origin-pool
F5XC_ORIGIN_IP=192.0.2.1
F5XC_ORIGIN_PORT=443
F5XC_HC_NAME=your-healthcheck
```
...
| --- | --- | --- |
| `xF5XC_API_URLx` | `https://f5-sales-demo.console.ves.volterra.io` | XC Console API URL |
| `xF5XC_API_TOKENx` | `your-api-token` | API credential token |
| `xF5XC_TENANTx` | `f5-sales-demo-rljyvvmw` | Tenant name (appears in API responses) |
| `xF5XC_EMAILx` | `admin@example.com` | CSD notification email address |
| `xF5XC_NAMESPACEx` | `bot-defense` | Namespace |
| `xF5XC_LB_NAMEx` | `bot-defense-demo-2` | HTTP Load Balancer name |
| `xF5XC_DOMAINNAMEx` | `botdemo.sales-demo.f5demos.com` | FQDN to protect |
| `xF5XC_ROOT_DOMAINx` | `f5demos.com` | Root domain (eTLD+1) for CSD protected domain |
...
| `xF5XC_HC_NAMEx` | `juice-shop-hc` | Healthcheck name |
...
| `xF5XC_TENANTx` | Tenant name | `f5-sales-demo-rljyvvmw` |
| `xF5XC_EMAILx` | CSD notification email | `admin@example.com` |
| `xF5XC_NAMESPACEx` | Namespace | `bot-defense` |
| `xF5XC_LB_NAMEx` | HTTP Load Balancer name | `bot-defense-demo-2` |
| `xF5XC_DOMAINNAMEx` | FQDN to protect | `botdemo.sales-demo.f5demos.com` |
| `xF5XC_ROOT_DOMAINx` | Root domain (eTLD+1) | `f5demos.com` |
...
| `xF5XC_HC_NAMEx` | Healthcheck name | `juice-shop-hc` |

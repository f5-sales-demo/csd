...
<Aside type="note">
أهداف الاستخراج (`www.httpbin.org`، `jsonplaceholder.typicode.com`) **لن** تظهر في عرض شبكة CSD — يتم عرض نطاقات مصدر تحميل النصوص فقط. إشارة الاكتشاف الأساسية هنا هي **قراءات حقول النماذج**. راجع [حدود الاكتشاف](/csd/overview/#detection-boundaries) للتفاصيل.
</Aside>

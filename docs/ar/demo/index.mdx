...
<Aside type="note">
المصدر الافتراضي لعرض CSD التوضيحي هو تطبيق Juice Shop على `192.0.2.1:3000`. إذا كنت تستخدم مصدرًا مخصصًا (`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`)، تحقق من أنه يقدم صفحة HTML تحتوي على حقول نموذج — يحتاج CSD إلى عناصر نموذج لإثبات قدرات الكشف.
</Aside>

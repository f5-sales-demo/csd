...
<Aside type="tip">
**ذاكرة تخزين مؤقت DNS السلبية:** إذا استعلمت عن النطاق قبل وجود السجل، قد يكون المحلل العودي لديك قد خزّن استجابة `NXDOMAIN`. تحقق من خادم الأسماء الموثوق لاستبعاد الذاكرة المؤقتة القديمة:

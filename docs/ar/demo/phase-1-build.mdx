...
تقوم المرحلة 1 بنشر والتحقق من البنية التحتية الكاملة لـ CSD. أكمل جميع الخطوات بالترتيب — يجب أن تجتاز كل خطوة قبل المتابعة. ارجع إلى [الفهرس](/csd/demo/) لإكمال إعداد البيئة وحل المتغيرات قبل تشغيل هذه الأوامر.
...
إذا أعاد DNS-1 نتيجة فارغة بعد 60 ثانية، انظر [استكشاف الأخطاء — موازن التحميل عالق في VIRTUAL_HOST_PENDING_A_RECORD](/csd/demo/#lb-stuck-in-virtual_host_pending_a_record).

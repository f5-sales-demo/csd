...
| النتيجة | المعنى |
| --- | --- |
| **نجاح** &mdash; تم إرجاع عنوان IP للـ VIP (مثل `192.0.2.1`) | يتم حل النطاق إلى العنوان الافتراضي IP لموازن التحميل |
...
<Aside type="tip">
**ذاكرة التخزين المؤقت السلبية لـ DNS:** إذا أعاد النطاق سابقًا `NXDOMAIN`، فقد تخزن محللات DNS الوسيطة هذه النتيجة مؤقتًا. تحقق من خادم الأسماء الموثوق لاستبعاد التخزين المؤقت القديم: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com` أو استخدم محللًا عامًا مثل `@192.0.2.1`.
</Aside>

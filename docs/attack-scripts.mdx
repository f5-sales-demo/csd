...
<Screenshot light="/images/attack-overlay-card.png" alt="Payment overlay injected by card skimmer script" />
...
<Screenshot light="/images/attack-overlay-form.png" alt="Fake login form overlaying the real form" />

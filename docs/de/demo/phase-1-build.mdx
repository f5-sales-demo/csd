...
Phase 1 stellt die vollständige CSD-Infrastruktur bereit und validiert sie. Alle Schritte müssen der Reihe nach abgeschlossen werden — jeder Schritt muss BESTANDEN sein, bevor fortgefahren wird. Kehren Sie zum [Index](/csd/de/demo/) zurück, um die Umgebungseinrichtung und Variablenauflösung abzuschließen, bevor Sie diese Befehle ausführen.
...
Wenn DNS-1 nach 60 Sekunden leer zurückgibt, siehe [Fehlerbehebung &mdash; LB verbleibt in VIRTUAL_HOST_PENDING_A_RECORD](/csd/de/demo/#lb-stuck-in-virtual_host_pending_a_record).
...
**Phase 1 abgeschlossen.** Fahren Sie mit [Phase 2 — Angriff](/csd/de/demo/phase-2-attack/) fort, um die Angriffssimulation durchzuführen.

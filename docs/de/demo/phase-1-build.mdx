...
<Aside type="tip">
**Negativer DNS-Cache:** Wenn Sie die Domain abgefragt haben, bevor der Eintrag vorhanden war, hat Ihr rekursiver Resolver möglicherweise die `NXDOMAIN`-Antwort zwischengespeichert. Überprüfen Sie den autoritären Nameserver, um veralteten Cache auszuschließen:

...
4. **Das kombinierte Erkennungsskript ausführen** — fügen Sie das Skript aus [Auslösung der Erkennung &mdash; Das kombinierte Simulationsskript ausführen](/csd/trigger-detection/#run-the-combined-simulation-script) in die Konsole ein und drücken Sie Enter
...
**Phase 2 abgeschlossen.** Fahren Sie mit [Phase 3 — Abwehr](/csd/demo/phase-3-mitigate/) fort, um Abwehrregeln anzuwenden und zu überprüfen, ob Domänen blockiert werden.

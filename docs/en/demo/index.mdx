...
<Aside type="note">
The default origin for the CSD demo is the Juice Shop application at `192.0.2.1:3000`. If you are using a custom origin (`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`), verify that it serves an HTML page with form fields — CSD needs form elements to demonstrate detection capabilities.
</Aside>

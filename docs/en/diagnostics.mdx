...
| Result | Meaning |
| --- | --- |
| **PASS** &mdash; VIP IP returned (e.g., `203.0.113.10`) | Domain resolves to the LB virtual IP |
...
<Aside type="tip">
**Negative DNS cache:** If the domain previously returned `NXDOMAIN`, recursive
resolvers may cache that result. Verify against the F5 authoritative nameserver
to rule out stale cache:

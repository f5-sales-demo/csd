...
Después de ejecutar la [simulación combinada](/csd/es/trigger-detection/) y tomar acción sobre los dominios CDN inyectados (`cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io`) mediante el menú de acciones, esos dominios también aparecerán en la tabla con estado **Encontrado y permitido** o **Encontrado y mitigado**.
...
Para la mitigación programática a través de la API, consulte [Referencia de API — Mitigación](/csd/es/api-reference/#mitigation).

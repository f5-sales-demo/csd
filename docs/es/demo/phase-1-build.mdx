...
<Aside type="tip">
**Caché DNS negativa:** Si consultó el dominio antes de que existiera el registro, su resolver recursivo puede haber almacenado en caché la respuesta `NXDOMAIN`. Verifique contra el servidor de nombres autoritativo para descartar caché obsoleta:

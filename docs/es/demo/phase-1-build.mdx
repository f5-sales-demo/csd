...
La Fase 1 despliega y valida la infraestructura completa de CSD. Complete todos los pasos en orden — cada paso debe superar la verificación (PASS) antes de continuar. Regrese al [índice](/csd/demo/) para completar la configuración del entorno y la resolución de variables antes de ejecutar estos comandos.
...
Si DNS-1 devuelve vacío después de 60 segundos, consulte [Solución de problemas &mdash; LB bloqueado en VIRTUAL_HOST_PENDING_A_RECORD](/csd/demo/#lb-stuck-in-virtual_host_pending_a_record).
...
**Fase 1 completada.** Continúe con la [Fase 2 — Ataque](/csd/demo/phase-2-attack/) para ejecutar la simulación de ataque.

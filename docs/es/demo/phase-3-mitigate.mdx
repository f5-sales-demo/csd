...
| Señal sintética a `www.httpbin.org` | `200` — señal enviada | `200` — el fetch aún se completa (CSD no intercepta fetch) |
| Señal sintética a jsonplaceholder.typicode.com | `201` — señal enviada | `201` — el fetch aún se completa (CSD no intercepta fetch) |

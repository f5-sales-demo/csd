...
| --- | --- |
| **CORRECTO** &mdash; IP VIP devuelta (p. ej., `203.0.113.10`) | El dominio resuelve a la IP virtual del LB |
...
<Aside type="tip">
**Caché DNS negativa:** Si el dominio devolvió previamente `NXDOMAIN`, los resolvedores recursivos pueden almacenar en caché ese resultado. Verifique contra el servidor de nombres autoritativo para descartar caché obsoleta: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com`.
</Aside>

...
Las alertas pueden definirse por dominio o aplicarse globalmente a todos los dominios protegidos. Consulte la sección [F5 XC Consola de CSD — Configuración de alertas](/csd/csd-console/#alert-configuration) para obtener detalles de configuración.
...
Consulte la guía de [Diagnósticos](/csd/diagnostics/) para conocer las pruebas de verificación completas de Capa 7 (HTTP) y Capa 8 (telemetría CSD).
...
Los clientes pueden consultar estos endpoints de la API de forma periódica y reenviar los datos de detección a su SIEM. Consulte la [Referencia de API](/csd/api-reference/) para obtener detalles sobre los endpoints y la autenticación.
...
Consulte la [Fase 3 — Mitigar](/csd/demo/phase-3-mitigate/) para ver una demostración antes/después del comportamiento de bloqueo de scripts.
...
Consulte la sección [Fase 2 — Verificación de detección](/csd/demo/phase-2-attack/#step-9-detection-verification-via-api) para conocer el protocolo de consulta recomendado.

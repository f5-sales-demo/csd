...
See [Phase 3 — Mitigate](/csd/demo/phase-3-mitigate/) for a before/after proof demonstrating script blocking behavior.
...
See the [Phase 2 — Detection Verification](/csd/demo/phase-2-attack/#step-9-detection-verification-via-api) section for the recommended polling protocol.

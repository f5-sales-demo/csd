...
| [Phase 3 — Atténuer](/csd/demo/phase-3-mitigate/) | Preuve avant/après atténuation — exécuter l'attaque, appliquer les atténuations, ré-exécuter l'attaque, comparer | Étapes 1–6 |
| [Phase 4 — Désinstaller](/csd/demo/phase-4-teardown/) | Supprimer tous les objets de déploiement après confirmation explicite | Désinstallation |
...
| `false`/`null` | Externe | **INFO** | Les enregistrements gérés ne sont pas applicables pour le DNS externe — la Phase 1 Étape 4 utilisera [l'Option B](/csd/demo/phase-1-build/#option-b-external-dns-provider) (création manuelle d'enregistrements) |
...
- Consultez les encadrés de la [simulation d'attaque Phase 2](/csd/demo/phase-2-attack/) pour
...
Référencez les identifiants de cas de test [Diagnostics &amp; Vérification](/csd/diagnostics/) (DNS-1, TLS-1, LB-1, CSD-1, etc.) comme norme de vérification pour chaque couche.
...
3. Recréez le LB HTTPS ([Phase 1 Étape 3](/csd/demo/phase-1-build/#step-3-create-http-load-balancers-with-csd))

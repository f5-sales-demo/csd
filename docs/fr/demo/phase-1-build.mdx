...
<Aside type="tip">
**Cache DNS négatif :** Si vous avez interrogé le domaine avant que l'enregistrement existe, votre résolveur récursif peut avoir mis en cache la réponse `NXDOMAIN`. Vérifiez auprès du serveur de noms faisant autorité pour écarter un cache périmé :

...
| Signal synthétique vers `www.httpbin.org` | `200` — signal envoyé | `200` — fetch se termine toujours (CSD n'intercepte pas fetch) |
| Signal synthétique vers jsonplaceholder.typicode.com | `201` — signal envoyé | `201` — fetch se termine toujours (CSD n'intercepte pas fetch) |

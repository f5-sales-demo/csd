...
| --- | --- |
| **RÉUSSITE** &mdash; IP VIP retournée (ex. `203.0.113.10`) | Le domaine résout vers l'IP virtuelle du LB |
...
<Aside type="tip">
**Cache DNS négatif :** Si le domaine a précédemment retourné `NXDOMAIN`, les résolveurs récursifs peuvent mettre en cache ce résultat. Vérifiez auprès du serveur de noms faisant autorité pour exclure un cache périmé : `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com`.
</Aside>

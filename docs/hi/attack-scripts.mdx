...
<Aside type="note">
एक्सफ़िल्ट्रेशन लक्ष्य (`www.httpbin.org`, `jsonplaceholder.typicode.com`) CSD Network व्यू में **दिखाई नहीं देंगे** — केवल स्क्रिप्ट-लोड स्रोत डोमेन दिखाए जाते हैं। यहाँ प्राथमिक डिटेक्शन संकेत **फ़ॉर्म फ़ील्ड रीड** है। विवरण के लिए [Detection Boundaries](/csd/overview/#detection-boundaries) देखें।
</Aside>

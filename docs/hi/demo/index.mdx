...
| चरण | लक्ष्य | स्टेप्स |
| --- | --- | --- |
| [चरण 1 — बिल्ड](/csd/demo/phase-1-build/) | पूर्ण CSD इन्फ्रास्ट्रक्चर को डिप्लॉय और वैलिडेट करें | स्टेप्स 1–7 |
| [चरण 2 — अटैक](/csd/demo/phase-2-attack/) | सिमुलेटेड अटैक ट्रैफिक जनरेट करें और CSD द्वारा इसकी पहचान की पुष्टि करें | स्टेप्स 8–9 |
| [चरण 3 — मिटिगेट](/csd/demo/phase-3-mitigate/) | मिटिगेशन से पहले/बाद का प्रमाण — अटैक चलाएं, मिटिगेशन लागू करें, अटैक पुनः चलाएं, तुलना करें | स्टेप्स 1–6 |
| [चरण 4 — टियरडाउन](/csd/demo/phase-4-teardown/) | स्पष्ट पुष्टि के बाद सभी डिप्लॉयमेंट ऑब्जेक्ट्स हटाएं | टियरडाउन |
...
[चरण 1 — स्टेप 7: सत्यापन](/csd/demo/phase-1-build/#step-7-verify) से सटीक कमांड का उपयोग करें:
...
| `false`/`null` | बाहरी | **INFO** | बाहरी DNS के लिए प्रबंधित रिकॉर्ड लागू नहीं — चरण 1 स्टेप 4 [विकल्प B](/csd/demo/phase-1-build/#option-b-external-dns-provider) (मैनुअल रिकॉर्ड निर्माण) का उपयोग करेगा |
...
- क्षणिक ऑरिजिन विफलताओं और संसाधन समाप्ति पुनर्प्राप्ति पर विस्तृत मार्गदर्शन
  के लिए [चरण 2 अटैक सिमुलेशन](/csd/demo/phase-2-attack/) एसाइड देखें
...
प्रत्येक परत के सत्यापन मानक के रूप में [डायग्नोस्टिक्स और सत्यापन](/csd/diagnostics/) टेस्ट केस ID (DNS-1, TLS-1, LB-1, CSD-1, आदि) का संदर्भ लें।
...
2. **`allow_http_lb_managed_records` जांचें** — यदि ज़ोन मौजूद है लेकिन LB पेंडिंग है, तो प्रबंधित रिकॉर्ड अक्षम हो सकते हैं:
   ...
   curl -s \
     ...
     | jq '.spec.primary.allow_http_lb_managed_records'
   ```
   यदि `false` या `null` है, तो इसे [चरण 1 स्टेप 4, विकल्प A](/csd/demo/phase-1-build/#option-a-f5-xc-managed-dns) में `PUT` कमांड का उपयोग करके सक्षम करें।

3. **बाहरी DNS** — यदि F5 XC प्राधिकृत नहीं है, तो अपने DNS प्रदाता पर मैन्युअल रूप से A और ACME CNAME रिकॉर्ड बनाएं (देखें [चरण 1 स्टेप 4, विकल्प B](/csd/demo/phase-1-build/#option-b-external-dns-provider))।
...
3. HTTPS लोड बैलेंसर पुनः बनाएं ([चरण 1 स्टेप 3](/csd/demo/phase-1-build/#step-3-create-http-load-balancers-with-csd))
4. प्रमाणपत्र स्थिति मॉनिटर करें ([चरण 1 स्टेप 7](/csd/demo/phase-1-build/#step-7-verify)) — 5–10 मिनट के भीतर `CertificateValid` की अपेक्षा करें

...
जब `F5XC_ORIGIN_IP` इनमें से किसी श्रेणी के पते पर सेट है, तो यह
एक जानबूझकर किया गया दस्तावेज़ीकरण प्लेसहोल्डर है — गलत कॉन्फ़िगरेशन नहीं।
</Aside>
...
<Aside type="note">
CSD डेमो के लिए डिफ़ॉल्ट ऑरिजिन `192.0.2.1:3000` पर Juice Shop एप्लिकेशन है। यदि आप कस्टम ऑरिजिन (`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`) का उपयोग कर रहे हैं, तो सत्यापित करें कि यह फॉर्म फ़ील्ड वाला HTML पेज प्रदान करता है — CSD को डिटेक्शन क्षमताओं का प्रदर्शन करने के लिए फॉर्म तत्वों की आवश्यकता है।
</Aside>
...
| `xF5XC_ORIGIN_IPx` | `192.0.2.1` | ऑरिजिन सर्वर IP |
...
| `xF5XC_ORIGIN_IPx` | ऑरिजिन सर्वर IP | `192.0.2.1` |

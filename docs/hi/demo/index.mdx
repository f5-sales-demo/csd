---
title: डेमो
description: '4-चरणीय डेमो अभ्यास अवलोकन — बिल्ड, अटैक, मिटिगेट, टियरडाउन'
sidebar:
  order: 1
  label: अवलोकन
i18n:
...
<Aside type="caution">
प्लेसहोल्डर फॉर्म मान — जिसमें आपका API टोकन भी शामिल है — ब्राउज़र के `localStorage` में संग्रहीत करता है। साझा या सार्वजनिक मशीनों पर प्रोडक्शन टोकन का उपयोग न करें।
</Aside>
...
| चरण | लक्ष्य | स्टेप्स |
| --- | --- | --- |
| [चरण 1 — बिल्ड](/csd/hi/demo/phase-1-build/) | पूर्ण CSD इन्फ्रास्ट्रक्चर को डिप्लॉय और वैलिडेट करें | स्टेप्स 1–7 |
| [चरण 2 — अटैक](/csd/hi/demo/phase-2-attack/) | सिमुलेटेड अटैक ट्रैफिक जनरेट करें और CSD द्वारा इसकी पहचान की पुष्टि करें | स्टेप्स 8–9 |
| [चरण 3 — मिटिगेट](/csd/hi/demo/phase-3-mitigate/) | मिटिगेशन से पहले/बाद का प्रमाण — अटैक चलाएं, मिटिगेशन लागू करें, अटैक पुनः चलाएं, तुलना करें | स्टेप्स 1–6 |
| [चरण 4 — टियरडाउन](/csd/hi/demo/phase-4-teardown/) | स्पष्ट पुष्टि के बाद सभी डिप्लॉयमेंट ऑब्जेक्ट्स हटाएं | टियरडाउन |
...
जब सभी चरण 1 ऑब्जेक्ट्स मौजूद हों (`200`) और आप चरण 2 पर जाने की योजना बना रहे हों,
तो स्किप करने से पहले इन्फ्रास्ट्रक्चर स्वास्थ्य की पुष्टि करने के लिए
**चरण 1 स्टेप 7 सत्यापन कमांड** चलाएं।
[चरण 1 — स्टेप 7: सत्यापन](/csd/hi/demo/phase-1-build/#step-7-verify) से सटीक कमांड का उपयोग करें:
...
<Aside type="note">
मिटिगेटेड डोमेन सूची 1 की गिनती लौटा सकती है जिसमें null मेटाडेटा हो, भले ही कोई वास्तविक मिटिगेशन मौजूद न हो। यह एक बैकेंड आर्टिफैक्ट है। निर्णय नियम: यदि एकल आइटम में null मेटाडेटा है (name null या खाली है), तो इसे 0 मानें। यदि इसमें वास्तविक मेटाडेटा है, तो आगे बढ़ने से पहले प्रत्येक आइटम को name से हटाएं।
</Aside>

<Aside type="note">
CSD डिटेक्शन इन्फ्रास्ट्रक्चर टियरडाउन/रीबिल्ड के बाद भी बने रहते हैं जब वही प्रोटेक्टेड डोमेन उसी टेनेंट पर पुनः रजिस्टर किया जाता है। टियरडाउन और रीबिल्ड के बाद, एक बार `/detected_domains` क्वेरी करें। यदि प्रतिक्रिया में आइटम हैं, तो तुरंत आगे बढ़ें — प्रतीक्षा की आवश्यकता नहीं है। यदि प्रतिक्रिया खाली है, तो 30 सेकंड प्रतीक्षा करें और एक बार फिर क्वेरी करें। यदि दूसरी क्वेरी के बाद भी खाली है, तो वैसे भी आगे बढ़ें — सिमुलेशन चलने पर डिटेक्शन दिखाई देंगे।
</Aside>
...
| टियर | श्रेणी | डेमो ब्लॉक करता है? | उद्देश्य |
| --- | --- | --- | --- |
...
<Aside type="note">
**नेमस्पेस + RBAC इंटरैक्शन।** यदि PF-T0-2 ने `404` लौटाया (नेमस्पेस मौजूद नहीं है) और PF-T0-4 दिखाता है कि नेमस्पेस राइट अस्वीकृत है, तो डेमो **आगे नहीं बढ़ सकता** — नेमस्पेस न तो मौजूद है और न ही बनाया जा सकता है। यदि PF-T0-2 ने `200` लौटाया (नेमस्पेस मौजूद है) और नेमस्पेस राइट अस्वीकृत है, तो यह केवल एक चेतावनी है — डेमो पहले से मौजूद नेमस्पेस का उपयोग कर सकता है।

**CSD + RBAC।** यदि CSD एंडपॉइंट `403` लौटाते हैं, तो CSD सेवा इस नेमस्पेस या टेनेंट के लिए सक्षम नहीं हो सकती (प्लान-आधारित एक्सेस कंट्रोल)। चूंकि CSD प्रदर्शित की जा रही मुख्य सुविधा है, यह हमेशा FAIL है।
</Aside>
...
<Aside type="note">
Quota Usage API सभी नेमस्पेस में टेनेंट-व्यापी कुल योग लौटाता है, प्रति-नेमस्पेस गणना नहीं। `-1` का `limit` मान (`"unlimited"` के रूप में प्रदर्शित) का अर्थ है कि उस ऑब्जेक्ट प्रकार के लिए कोटा सीमित नहीं है। यदि API `403`, `404`, या अप्रत्याशित प्रारूप लौटाता है, तो नीचे दी गई [प्रोब-आधारित जांचों](#फॉलबैक-प्रोब-आधारित-कोटा-जांचें) पर वापस जाएं।
</Aside>
...
<Aside type="note">
प्रोब RFC 2606 आरक्षित डोमेन `example.com` का उपयोग करता है। `409` प्रतिक्रिया एक वैध PASS है — इसका अर्थ है कि डोमेन पहले से रजिस्टर है, जो साबित करता है कि कोटा समाप्त नहीं हुआ है। यदि `409` हुआ (प्रोब कभी नहीं बना) तो DELETE `404` लौटा सकता है, जो अपेक्षित है।
</Aside>
...
<Aside type="caution">
प्रोब-आधारित जांचें टेनेंट पर वास्तविक ऑब्जेक्ट बनाती हैं और उन्हें तुरंत हटाती हैं। यदि विलोपन विफल होता है (उदा., नेटवर्क समस्या), तो बचे हुए प्रोब ऑब्जेक्ट रह सकते हैं। [T4 बचे हुए प्रोब क्लीनअप](#t4-वातावरण-साफ) अगले प्री-फ्लाइट रन में उन्हें पहचानेगा और हटाएगा।
</Aside>
...
<Aside type="caution">
ज़ोन spec में एक `x-ves-io-managed` rr_set_group होता है जिसमें प्लेटफॉर्म-प्रबंधित रिकॉर्ड होते हैं। `PUT` पेलोड को **इस समूह को संरक्षित करना चाहिए** — इसे हटाने से HTTP 403 "reserved for internal purposes" त्रुटि होती है। हमेशा पहले `GET` के साथ वर्तमान ज़ोन कॉन्फ़िगरेशन प्राप्त करें, केवल `allow_http_lb_managed_records` फ़ील्ड को संशोधित करें, और पूर्ण spec वापस भेजें।
</Aside>
...
| `false`/`null` | बाहरी | **INFO** | बाहरी DNS के लिए प्रबंधित रिकॉर्ड लागू नहीं — चरण 1 स्टेप 4 [विकल्प B](/csd/hi/demo/phase-1-build/#option-b-external-dns-provider) (मैनुअल रिकॉर्ड निर्माण) का उपयोग करेगा |
...
इंटरनेट पर **रूटेबल नहीं** हैं और कनेक्टिविटी परीक्षणों का कभी उत्तर नहीं देंगे।
इन श्रेणियों का `F5XC_ORIGIN_IP` दस्तावेज़ीकरण प्लेसहोल्डर है और आगे बढ़ने से
पहले इसे अधिकृत लैब ऑरिजिन से बदलना आवश्यक है।
</Aside>

**प्लेसहोल्डर गार्ड:** कनेक्टिविटी परीक्षण चलाने से पहले ऑरिजिन IP सत्यापित करें:
...
यदि `status` `FAIL` है, तो रुकें और प्लेसहोल्डर को अधिकृत लैब ऑरिजिन से बदलें। अन्यथा, नीचे दी गई जांचें चलाएं।
...
<Aside type="note">
डिफ़ॉल्ट `.env.example` ऑरिजिन, `198.51.100.10:3000`, RFC 5737 का डॉक्यूमेंटेशन प्लेसहोल्डर है और रूट नहीं होता। पूरा डेमो चलाने से पहले `F5XC_ORIGIN_IP` और `F5XC_ORIGIN_PORT` को अपने अधिकृत लैब ऑरिजिन पर सेट करें, फिर सत्यापित करें कि यह फॉर्म फ़ील्ड वाला HTML पेज प्रदान करता है। CSD को डिटेक्शन क्षमताओं का प्रदर्शन करने के लिए फॉर्म तत्वों की आवश्यकता है।
</Aside>
...
ये जांचें सत्यापित करती हैं कि पिछले डेमो रन से कोई **नामित F5 XC कॉन्फ़िगरेशन ऑब्जेक्ट** नहीं बचे हैं — HTTP लोड बैलेंसर, HTTPS लोड बैलेंसर,
ऑरिजिन पूल, हेल्थचेक, प्रोटेक्टेड डोमेन, और मिटिगेटेड डोमेन।
T4 ऑब्जेक्ट-स्तरीय क्लीनअप के बारे में है: क्या API ऑब्जेक्ट जो चरण 1 निर्माण के साथ टकराव करेंगे अभी भी मौजूद हैं। यह IP
पतों, नेटवर्क कनेक्टिविटी, या ऑरिजिन स्वास्थ्य का परीक्षण नहीं करता (वे चिंताएं
T3 से संबंधित हैं)।

<Aside type="note">
**जब नेमस्पेस मौजूद नहीं है तो T4 छोड़ें।** यदि PF-T0-2 ने `404` लौटाया (नेमस्पेस मौजूद नहीं है), तो T4 वातावरण जांच पूरी तरह से छोड़ें और स्थिति `CLEAN` के रूप में रिपोर्ट करें। एक गैर-मौजूद नेमस्पेस में बचे हुए ऑब्जेक्ट नहीं हो सकते। किसी भी ऑब्जेक्ट बनाने से पहले चरण 1 स्टेप 0 नेमस्पेस बनाएगा।
</Aside>

ऊपर [प्री-फ्लाइट जांच](#प्री-फ्लाइट-जांच) अनुभाग से छह प्री-फ्लाइट कमांड चलाएं। अगले कदम निर्धारित करने के लिए [निर्णय तर्क](#निर्णय-तर्क) लागू करें। यदि ऑब्जेक्ट मौजूद हैं, तो तैयारी चरण के दौरान स्वतः-टियरडाउन किया जाता है (पुष्टि की आवश्यकता नहीं)।

पिछले बाधित प्री-फ्लाइट रन से बचे हुए प्रोब ऑब्जेक्ट्स की भी जांच करें और हटाएं। ये प्रोब केवल तब बनाए जाते हैं जब Quota Usage API अनुपलब्ध हो और [फॉलबैक प्रोब-आधारित जांचों](#फॉलबैक-प्रोब-आधारित-कोटा-जांचें) का उपयोग किया गया हो, या प्रोटेक्टेड डोमेन प्रोब (PF-T1-4) के लिए जो हमेशा प्रोब-आधारित जांच का उपयोग करता है:
...
<Aside type="note">
Let's Encrypt दर सीमा स्थिति को सीधे क्वेरी करने के लिए कोई API नहीं है। यह जांच प्रॉक्सी के रूप में HTTPS LB cert state का उपयोग करती है। यदि अभी तक कोई HTTPS LB मौजूद नहीं है (साफ वातावरण), तो यह जांच छोड़ दी जाती है — हालिया डेमो आवृत्ति के आधार पर जोखिम सूचनात्मक के रूप में नोट किया जाता है।
</Aside>
...
> **खाली स्ट्रिंग = अनुपलब्ध:** खाली मान के साथ निर्यातित वेरिएबल
> (उदा., `F5XC_HC_NAME=""`) को अनसेट वेरिएबल के समान माना जाता है —
> डिफ़ॉल्ट लागू करें। एक चरण में डिफ़ॉल्ट लागू करने के लिए शेल पैरामीटर एक्सपैंशन
> (`${F5XC_HC_NAME:-csd-hc}`) का उपयोग करें।

6. **पुष्टि प्रदर्शित करें** — ऑपरेटर को अंतिम हल किए गए वेरिएबल तालिका दिखाएं और किसी भी API कॉल निष्पादित करने से पहले अनुमोदन की प्रतीक्षा करें।

> **तैयारी चरण ओवरराइड:** स्टेज 1 तैयारी के दौरान, चरण 6 में प्रतीक्षा छोड़ें।
> रिकॉर्ड के लिए हल किए गए वेरिएबल तालिका प्रदर्शित करें, फिर तुरंत आगे बढ़ें।
> चरण 1–5 अभी भी लागू होते हैं — यदि `.env` और शेल जांचने के बाद कोई आवश्यक
> वेरिएबल अनुपलब्ध है, तो रुकें और अनुपलब्ध वेरिएबल रिपोर्ट करें।

### आवश्यक बनाम वैकल्पिक वेरिएबल

| वेरिएबल | आवश्यक | डिफ़ॉल्ट | प्लेसहोल्डर (अनुपलब्ध मानें) |
| --- | --- | --- | --- |
...
| `F5XC_ORIGIN_IP` | **हां** | — | `198.51.100.10` |
...
- हर API कॉल, सत्यापन क्वेरी, और शेल कमांड **चरण फाइलों**
  (चरण 1–4) या ऊपर दिए गए प्री-फ्लाइट जांच अनुभाग से **यथावत** आना चाहिए
...
- यदि कोई आवश्यक कमांड प्रलेखित नहीं है, तो रुकें और ऑपरेटर को रिपोर्ट करें:
  "यह सत्यापन कदम चरण दस्तावेज़ीकरण द्वारा कवर नहीं है"

**डीबग मोड** (विफलता पर स्वतः-सक्रिय):

- जब कोई प्रलेखित कमांड अप्रत्याशित परिणाम उत्पन्न करता है तो स्वचालित रूप से
  सक्रिय होता है: गैर-2xx HTTP प्रतिक्रिया, jq पार्स त्रुटि, कमांड टाइमआउट,
  या प्रतिक्रिया बॉडी जो साक्ष्य तालिका का खंडन करती है
- डीबग मोड में, AI सहायक डायग्नोस्टिक कमांड बना सकता है, कच्ची API
  प्रतिक्रियाओं का निरीक्षण कर सकता है, एंडपॉइंट भिन्नताओं का परीक्षण कर
  सकता है, और मूल कारण खोजने के लिए रचनात्मक समस्या निवारण का उपयोग कर सकता है
- सभी डीबग आउटपुट को `[DEBUG]` के साथ उपसर्ग करें ताकि ऑपरेटर डायग्नोस्टिक
  गतिविधि को सामान्य निष्पादन से अलग कर सके
- **जो सीखें उसे दस्तावेज़ित करें**: किसी समस्या को हल करने के बाद, संबंधित
...
- डीबग मोड का लक्ष्य **स्वयं को समाप्त करना** है — प्रत्येक डीबग सत्र को
  एक दस्तावेज़ अपडेट उत्पन्न करना चाहिए जो अगले निष्पादन को पूरी तरह नियतात्मक बनाए
- दस्तावेज़ अपडेट होने और समस्या हल होने के बाद, सामान्य मोड पर लौटें और
  अंतिम सफल प्रलेखित कदम से पुनः शुरू करें
- यदि डीबग मोड समस्या हल नहीं कर सकता, तो ऑपरेटर को निष्कर्ष रिपोर्ट करें
  और रुकें — अगले चरण पर न जाएं

**प्रश्नोत्तर मोड** (प्रश्नोत्तर चरण के दौरान):

- केवल प्रश्नोत्तर मीटिंग चरण के दौरान सक्रिय, डेमो निष्कर्ष के बाद
- AI सहायक तदर्थ API कॉल बना सकता है, डायग्नोस्टिक कमांड चला सकता है,
  अस्क्रिप्टेड पृष्ठों पर नेविगेट कर सकता है, और दर्शकों के प्रश्नों का
  उत्तर देने के लिए लाइव डेमो वातावरण को संशोधित कर सकता है
- कोई `[DEBUG]` उपसर्ग नहीं — यह जानबूझकर सुधारात्मक व्यवहार है,
  त्रुटि पुनर्प्राप्ति नहीं
- उत्पाद प्रश्नों के लिए ज्ञान आधार के रूप में `DEMO_EXECUTOR.md` में CSD
  उत्पाद विशेषज्ञता अनुभाग का उपयोग करता है
...
- पिछले रन से संचित स्क्रिप्ट को साफ करने के लिए `initScript` के साथ किसी भी
  नेविगेशन से पहले **हमेशा `about:blank` पर नेविगेट करें**
- डेमो चरणों (उदा., चरण 2 → चरण 3) के बीच स्विच करते समय पूरी तरह साफ ब्राउज़र
  स्थिति सुनिश्चित करने के लिए `isolatedContext` के साथ **`new_page` का उपयोग करें**
- **अनुत्तरदायी पृष्ठों से पुनर्प्राप्ति** — यदि `take_screenshot` या
  `take_snapshot` टाइमआउट होते हैं, तो ब्राउज़र संदर्भ संसाधन-समाप्त है।
  एक ताज़ा संदर्भ बनाने के लिए `isolatedContext` के साथ `new_page` का उपयोग
  करें, फिर `about:blank` नेविगेशन कदम से पुनः प्रयास करें
- क्षणिक ऑरिजिन विफलताओं और संसाधन समाप्ति पुनर्प्राप्ति पर विस्तृत मार्गदर्शन
  के लिए [चरण 2 अटैक सिमुलेशन](/csd/hi/demo/phase-2-attack/) एसाइड देखें
...
प्रत्येक परत के सत्यापन मानक के रूप में [डायग्नोस्टिक्स और सत्यापन](/csd/hi/diagnostics/) टेस्ट केस ID (DNS-1, TLS-1, LB-1, CSD-1, आदि) का संदर्भ लें।
...
- एक **F5 XC API टोकन** — **Administration** &rarr; **Credentials** &rarr; **API Credentials** के अंतर्गत एक जनरेट करें
...
# आवश्यक — ऊपर दिए गए non-routable documentation address को बदलें
...
<Aside type="caution">
`.env` फाइल में आपका API टोकन होता है। यह `.gitignore` में सूचीबद्ध है और इसे कभी भी संस्करण नियंत्रण में कमिट नहीं किया जाना चाहिए।
</Aside>
...
<Aside type="tip">
यदि आपके API टोकन में `/` या `=` अक्षर हैं, तो शेल व्याख्या समस्याओं से बचने के लिए `.env` में मान को सिंगल कोट्स में रखें (उदा., `F5XC_API_TOKEN='abc/def='`)।

कुछ कंटेनर रनटाइम और सीक्रेट मैनेजर एनवायरनमेंट वेरिएबल मानों में शाब्दिक उद्धरण अक्षर इंजेक्ट करते हैं। यदि वैध टोकन के बावजूद API कॉल `401 Unauthorized` लौटाते हैं, तो उपयोग से पहले भटके हुए उद्धरण हटाएं:
...
| `xF5XC_ORIGIN_IPx` | `198.51.100.10` | ऑरिजिन सर्वर IP |
| `xF5XC_ORIGIN_PORTx` | `3000` | ऑरिजिन सर्वर पोर्ट |
| `xF5XC_HC_NAMEx` | `csd-hc` | हेल्थचेक नाम |

<Aside type="tip">
**टेनेंट स्वचालित है**: टेनेंट पहचानकर्ता आपके API URL से व्युत्पन्न होता है (उदा., `https://f5-amer-ent.console.ves.volterra.io` से `f5-amer-ent`)। आपको इसे प्रदान करने की आवश्यकता नहीं है — ऑब्जेक्ट बनाते समय प्लेटफॉर्म स्वचालित रूप से टेनेंट संदर्भ भरता है।
</Aside>
...
[AI सहायक निष्पादन प्रोटोकॉल](#वेरिएबल-रिज़ॉल्यूशन-प्रोटोकॉल) में परिभाषित नियतात्मक प्रोटोकॉल का उपयोग करके मान हल किए जाते हैं:
...
4. **चरण 4 — टियरडाउन** _(स्पष्ट मानव पुष्टि आवश्यक)_: HTTPS LB हटाएं &rarr; HTTP LB &rarr; origin pool &rarr; DNS ज़ोन क्लीनअप (केवल मैनुअल रिकॉर्ड) &rarr; healthcheck &rarr; protected domain। DNS ज़ोन **न हटाएं**।
</Steps>
...
| `xF5XC_ORIGIN_IPx` | ऑरिजिन सर्वर IP | `198.51.100.10` |
...
- **401 Unauthorized** — API टोकन अमान्य या समाप्त है। **Administration** &rarr; **Credentials** के अंतर्गत पुनः जनरेट करें।
...
2. **`allow_http_lb_managed_records` जांचें** — यदि ज़ोन मौजूद है लेकिन LB पेंडिंग है, तो प्रबंधित रिकॉर्ड अक्षम हो सकते हैं:
   ...
   curl -s \
     ...
     | jq '.spec.primary.allow_http_lb_managed_records'
   ```
   यदि `false` या `null` है, तो इसे [चरण 1 स्टेप 4, विकल्प A](/csd/hi/demo/phase-1-build/#option-a-f5-xc-managed-dns) में `PUT` कमांड का उपयोग करके सक्षम करें।

3. **बाहरी DNS** — यदि F5 XC प्राधिकृत नहीं है, तो अपने DNS प्रदाता पर मैन्युअल रूप से A और ACME CNAME रिकॉर्ड बनाएं (देखें [चरण 1 स्टेप 4, विकल्प B](/csd/hi/demo/phase-1-build/#option-b-external-dns-provider))।
...
<Aside type="note">
यह समस्या निवारण कदम केवल **HTTPS LB** (`${F5XC_LB_NAME}-https`) पर लागू होता है और **डेमो प्रगति के लिए वैकल्पिक** है। HTTP LB की प्रमाणपत्र निर्भरता नहीं है।
</Aside>
...
3. HTTPS लोड बैलेंसर पुनः बनाएं ([चरण 1 स्टेप 3](/csd/hi/demo/phase-1-build/#step-3-create-http-load-balancers-with-csd))
4. प्रमाणपत्र स्थिति मॉनिटर करें ([चरण 1 स्टेप 7](/csd/hi/demo/phase-1-build/#step-7-verify)) — 5–10 मिनट के भीतर `CertificateValid` की अपेक्षा करें

<Aside type="tip">
आपको DNS ज़ोन पुनः कॉन्फ़िगर करने, protected domain पुनः रजिस्टर करने, या HTTP LB को छूने की आवश्यकता नहीं है। ये स्थायी संसाधन हैं जो HTTPS LB पुनर्निर्माण से अप्रभावित हैं।
</Aside>

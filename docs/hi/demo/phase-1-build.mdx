...
चरण 1 पूर्ण CSD इंफ्रास्ट्रक्चर को तैनात और सत्यापित करता है। सभी चरण क्रम में पूरे करें — प्रत्येक चरण आगे बढ़ने से पहले PASS होना चाहिए। इन कमांड को चलाने से पहले एनवायरनमेंट सेटअप और वेरिएबल रेज़ोल्यूशन पूरा करने के लिए [इंडेक्स](/csd/demo/) पर वापस जाएं।
...
<Aside type="note">
**Let's Encrypt दर सीमाएं।** एक नया HTTPS LB बनाने से Let's Encrypt सर्टिफिकेट रिक्वेस्ट ट्रिगर होती है। Let's Encrypt प्रति सटीक identifier set प्रति 7 दिनों में केवल 5 duplicate certificates की अनुमति देता है। यदि `cert_state` `AutoCertDomainRateLimited` दिखाता है, तो डेमो HTTP LB का उपयोग करके जारी रहता है। इस सीमा तक पहुंचने से बचने के लिए, डिफ़ॉल्ट teardown HTTPS LB को skeleton के रूप में संरक्षित करता है — [चरण 4 — Teardown](/csd/demo/phase-4-teardown/) देखें।
</Aside>
...
यदि DNS-1 60 सेकंड बाद खाली लौटाता है, तो [समस्या निवारण &mdash; LB Stuck in VIRTUAL_HOST_PENDING_A_RECORD](/csd/demo/#lb-stuck-in-virtual_host_pending_a_record) देखें।
...
**चरण 1 पूरा।** आक्रमण सिमुलेशन चलाने के लिए [चरण 2 — आक्रमण](/csd/demo/phase-2-attack/) पर आगे बढ़ें।

...
<Aside type="tip">
**Negative DNS cache:** यदि आपने record मौजूद होने से पहले डोमेन query किया था, तो आपका recursive resolver `NXDOMAIN` रिस्पॉन्स cache कर सकता था। Stale cache को खारिज करने के लिए authoritative nameserver से सत्यापित करें:

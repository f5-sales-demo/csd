...
इन्फ्रास्ट्रक्चर सत्यापित होने के बाद (सभी चरण 1 स्टेप 7 जाँचें PASS), CSD डिटेक्शन उत्पन्न करने के लिए आक्रमण अनुकरण स्क्रिप्ट चलाएँ। स्क्रिप्ट [ट्रिगर डिटेक्शन](/csd/trigger-detection/) गाइड और [आक्रमण स्क्रिप्ट लाइब्रेरी](/csd/attack-scripts/) में परिभाषित हैं।
...
4. **Combined Detection Script चलाएँ** — [ट्रिगर डिटेक्शन &mdash; Combined Simulation Script चलाएँ](/csd/trigger-detection/#run-the-combined-simulation-script) से स्क्रिप्ट कंसोल में पेस्ट करें और Enter दबाएँ
...
अतिरिक्त लक्षित अनुकरण (व्यक्तिगत आक्रमण श्रेणियाँ, अधिकतम डिटेक्शन stress test) के लिए, [आक्रमण स्क्रिप्ट लाइब्रेरी](/csd/attack-scripts/) देखें।
</Aside>
...
डिटेक्शन की पुष्टि के लिए CSD API endpoints क्वेरी करें। polling loop का उपयोग करें: हर 60 सेकंड में `/detected_domains` क्वेरी करें; जैसे ही DET-3 पास हो आगे बढ़ें। यदि 10 मिनट के बाद DET-3 पास नहीं होता, CSD कॉन्फ़िगरेशन जाँचें। यदि 30 मिनट के बाद DET-3 पास नहीं होता, रुकें और ऑपरेटर को रिपोर्ट करें। ये endpoints [API संदर्भ](/csd/api-reference/) में दस्तावेज़ीकृत हैं और पिछले स्टेप्स की तरह ही प्रमाणीकरण और namespace का उपयोग करते हैं।
...
**चरण 2 पूर्ण।** mitigation नियम लागू करने और डोमेन ब्लॉक सत्यापित करने के लिए [चरण 3 — Mitigate](/csd/demo/phase-3-mitigate/) पर जाएँ।

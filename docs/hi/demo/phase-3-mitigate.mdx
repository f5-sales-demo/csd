...
<Aside type="caution">
**लाइव परीक्षण नोट:** शमन POST/DELETE एंडपॉइंट को विकास परिवेश में सत्यापित किया गया है, लेकिन व्यवहार संबंधी विवरण (प्रतिक्रिया टाइमिंग, स्क्रिप्ट डिटेक्शन स्थिति पर प्रभाव) टेनेंट कॉन्फ़िगरेशन के अनुसार भिन्न हो सकते हैं। यदि आप अप्रत्याशित प्रतिक्रियाएँ देखते हैं, तो कैनोनिकल एंडपॉइंट परिभाषाओं के लिए [API संदर्भ](/csd/api-reference/#mitigated-domains) देखें।
</Aside>
...
ब्राउज़र ऑटोमेशन उपकरणों के बिना ऑपरेटर [चरण 2 — चरण 8: हमला सिमुलेशन](/csd/demo/phase-2-attack/#step-8-attack-simulation) के समान प्रक्रिया का उपयोग करके सिमुलेशन को मैन्युअल रूप से चलाते हैं:
...
<Aside type="note">
mitigated domains list एंडपॉइंट सभी आइटम के लिए null `metadata.name` के साथ आइटम लौटाता है — सूची प्रतिक्रिया में अलग-अलग डोमेन नाम दिखाई नहीं देते। सत्यापित करें कि आइटम गिनती POST अनुरोधों की संख्या के बराबर है (मानक सिमुलेशन के लिए 6)। चरण 3 में प्रत्येक व्यक्तिगत POST से `200` प्रतिक्रिया ही आधिकारिक प्रमाण है कि प्रत्येक शमन बनाया गया था। यदि गिनती null-name आइटम के साथ 1 है और कोई शमन लागू नहीं किया गया था, तो गिनती को 0 मानें — यह एक बैकएंड आर्टिफैक्ट है (निर्णय नियम के लिए [प्री-फ़्लाइट जाँच](/csd/demo/#pre-flight-check) देखें)।
</Aside>
...
ब्राउज़र ऑटोमेशन उपकरणों के बिना ऑपरेटर [चरण 2 — चरण 8: हमला सिमुलेशन](/csd/demo/phase-2-attack/#step-8-attack-simulation) के समान प्रक्रिया का उपयोग करके सिमुलेशन को मैन्युअल रूप से फिर से चलाते हैं:
...
**चरण 3 पूरा।** सभी परिनियोजन ऑब्जेक्ट हटाने के लिए तैयार होने पर [चरण 4 — निष्कासन](/csd/demo/phase-4-teardown/) पर आगे बढ़ें।

...
| `www.httpbin.org` पर सिंथेटिक सिग्नल | `200` — सिग्नल भेजा गया | `200` — fetch अभी भी पूरी होती है (CSD fetch को इंटरसेप्ट नहीं करता) |
| jsonplaceholder.typicode.com पर सिंथेटिक सिग्नल | `201` — सिग्नल भेजा गया | `201` — fetch अभी भी पूरी होती है (CSD fetch को इंटरसेप्ट नहीं करता) |

...
ये कमांड [CSD Console Walkthrough](/csd/hi/csd-console/) के **API समकक्ष** हैं — इनका उपयोग तब करें जब आपको टर्मिनल से सत्यापन करना हो, निगरानी स्वचालित करनी हो, या UI के बिना CSD क्षमताओं का प्रदर्शन करना हो।

## पूर्वापेक्षाएँ

[API स्वचालन &mdash; परिवेश सेटअप](/csd/hi/demo/#environment-setup) में वर्णित अनुसार अपने परिवेश चर सेट करें:
...
<Aside type="note">
**PUT और DELETE, HTTP 200 पर खाली `\{\}` लौटाते हैं** — यह अपेक्षित सफलता प्रतिक्रिया है, कोई त्रुटि नहीं। केवल **POST** बनाई गई वस्तु लौटाता है। **सूची एंडपॉइंट** (जैसे, `/healthchecks`) और **व्यक्तिगत GET एंडपॉइंट** (जैसे, `/healthchecks/\{name\}`) अलग-अलग प्रतिक्रिया संरचनाएँ लौटाते हैं — प्रत्येक के लिए सही `jq` पथों के बारे में विवरण हेतु [API Reference &mdash; API Conventions](/csd/hi/api-reference/#api-conventions) देखें।
</Aside>
...
**सुधार:** [API स्वचालन &mdash; चरण 4: DNS कॉन्फ़िगर करें](/csd/hi/demo/phase-1-build/#step-4-configure-dns)
...
**सुधार:** [API स्वचालन &mdash; DNS अधिकार का पता लगाएँ](/csd/hi/demo/phase-1-build/#detect-dns-authority)
...
**सुधार:** [API स्वचालन &mdash; विकल्प A: F5 XC प्रबंधित DNS](/csd/hi/demo/phase-1-build/#option-a-f5-xc-managed-dns)
...
**सुधार:** [LB VIRTUAL_HOST_PENDING_A_RECORD में अटका हुआ](/csd/hi/demo/#lb-stuck-in-virtual_host_pending_a_record)
...
**सुधार:** [API Reference &mdash; लोड बैलेंसर पर CSD सक्षम करें](/csd/hi/api-reference/#enable-csd-on-a-load-balancer)
...
**सुधार:** [API स्वचालन &mdash; चरण 2: ऑरिजिन पूल बनाएँ](/csd/hi/demo/phase-1-build/#step-2-create-origin-pool)
...
| **FAIL** &mdash; एक स्वास्थ्य जाँच अपेक्षित थी लेकिन array खाली है | निर्माण के समय स्वास्थ्य जाँच नहीं मिली &mdash; [Healthcheck Not Linked](/csd/hi/demo/#healthcheck-not-linked-to-origin-pool) देखें |
...
| **FAIL** &mdash; `404` प्रतिक्रिया | स्वास्थ्य जाँच मौजूद नहीं (हो सकता है छोड़ दी गई हो &mdash; [चरण 1 Phase 1](/csd/hi/demo/phase-1-build/#step-1-create-healthcheck-optional) देखें) |
...
| **FAIL** &mdash; आइटमों में खाली `name` और `namespace` फ़ील्ड | कोई संरक्षित डोमेन पंजीकृत नहीं &mdash; [Phase 1 चरण 6](/csd/hi/demo/phase-1-build/#step-6-register-protected-domain) देखें |
...
ये कमांड [CSD कंसोल](/csd/hi/csd-console/) डैशबोर्ड, स्क्रिप्ट सूची, फ़ॉर्म फ़ील्ड, और नेटवर्क दृश्यों में प्रदर्शित समान डेटा क्वेरी करते हैं।
...
1. **DNS रिज़ॉल्यूशन जाँचें** &mdash; सत्यापित करें कि डोमेन LB VIP पर रिज़ॉल्व होता है:
   ...
   dig +short xF5XC_DOMAINNAMEx A
   ```
   यदि खाली है, DNS कॉन्फ़िगर नहीं है। [API स्वचालन &mdash; चरण 4](/csd/hi/demo/phase-1-build/#step-4-configure-dns) देखें।
...
प्रबंधित रिकॉर्ड सक्षम करने के लिए, `allow_http_lb_managed_records: true` सेट करने के लिए DNS ज़ोन कॉन्फ़िगरेशन अपडेट करें। API कॉल के लिए [API स्वचालन &mdash; विकल्प A: F5 XC प्रबंधित DNS](/csd/hi/demo/phase-1-build/#option-a-f5-xc-managed-dns) देखें।

### LB VIRTUAL_HOST_PENDING_A_RECORD में अटका हुआ

लोड बैलेंसर अपने VIP की ओर इंगित करने वाले DNS A रिकॉर्ड की प्रतीक्षा कर रहा है। विस्तृत समाधान चरणों के लिए [LB VIRTUAL_HOST_PENDING_A_RECORD में अटका हुआ](/csd/hi/demo/#lb-stuck-in-virtual_host_pending_a_record) देखें।

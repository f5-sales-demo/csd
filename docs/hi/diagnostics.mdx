...
| परिणाम | अर्थ |
| --- | --- |
| **PASS** &mdash; VIP IP लौटाया गया (जैसे, `192.0.2.1`) | डोमेन LB वर्चुअल IP पर रिज़ॉल्व होता है |
...
<Aside type="tip">
**नकारात्मक DNS कैश:** यदि डोमेन पहले `NXDOMAIN` लौटाता था, तो रिकर्सिव रिज़ॉल्वर उस परिणाम को कैश कर सकते हैं। पुराने कैश को नकारने के लिए आधिकारिक नेमसर्वर के विरुद्ध सत्यापित करें: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com` या `@192.0.2.1` जैसे सार्वजनिक रिज़ॉल्वर का उपयोग करें।
</Aside>

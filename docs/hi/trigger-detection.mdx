...
2. फॉर्म फील्ड में डमी क्रेडेंशियल दर्ज करें — **Email** फील्ड में `test@example.com` और **Password** फील्ड में `<DEMO_PASSWORD>` टाइप करें (फॉर्म सबमिट न करें)
...
<Aside type="tip">
डिटेक्शन को CSD डैशबोर्ड पर दिखाई देने में **5-10 मिनट** लगते हैं। यदि स्क्रिप्ट चलाने के बाद अलर्ट अभी तक दिखाई नहीं दे रहे हैं, तो [CSD कंसोल वॉकथ्रू](/csd/hi/csd-console/) के साथ जारी रखें और बाद में जाँचें।
</Aside>
...
| **सिंथेटिक नेटवर्क सिग्नल** | `fetch` से फ़ील्ड की संख्या और discard marker भेजता है; फ़ील्ड मान payload में कभी नहीं जाते | बाहरी डोमेन पर नेटवर्क कॉल (नोट: fetch गंतव्य स्क्रिप्ट नेटवर्क इंटरैक्शन के रूप में दिखाई देते हैं, Network डोमेन व्यू में नहीं) |

<Aside type="note">
CSD की विशिष्ट डिटेक्शन सीमाएँ हैं — उदाहरण के लिए, केवल पेज-लोड DOM फील्ड ट्रैक किए जाते हैं और Network व्यू केवल स्क्रिप्ट-लोड डोमेन दिखाता है। पूरी सूची के लिए [डिटेक्शन सीमाएँ](/csd/hi/overview/#detection-boundaries) देखें।
</Aside>

### उन्नत सिमुलेशन

उपरोक्त संयुक्त स्क्रिप्ट एक सरलीकृत 3-फेज़ वर्शन है (हार्वेस्ट, इंजेक्ट, एक्सफिल्ट्रेट) जो अधिकांश डेमो के लिए उपयुक्त है। [अटैक स्क्रिप्ट लाइब्रेरी](/csd/hi/attack-scripts/) अटैक प्रकार के अनुसार व्यवस्थित 10 लक्षित स्क्रिप्ट प्रदान करती है, जिसमें एक **Maximum Detection** स्ट्रेस टेस्ट शामिल है जो संयुक्त स्क्रिप्ट की कवरेज के ऊपर DOM मैनिपुलेशन, कुकी एक्सफिल्ट्रेशन, और इमेज बीकन चैनल जोड़ता है। विशिष्ट अटैक श्रेणियों (formjacking, digital skimming, supply chain injection, data exfiltration, DOM manipulation) को अलग-अलग प्रदर्शित करने के लिए अलग-अलग स्क्रिप्ट का उपयोग करें।

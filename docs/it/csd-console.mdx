...
Dopo aver eseguito la [simulazione combinata](/csd/trigger-detection/) e aver effettuato un'azione sui domini CDN iniettati (`cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io`) tramite il menu delle azioni, tali domini appariranno anch'essi nella tabella con lo stato **Trovato e consentito** o **Trovato e mitigato**.

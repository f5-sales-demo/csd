...
<Aside type="note">
L'origine predefinita per la demo CSD è l'applicazione Juice Shop all'indirizzo `192.0.2.1:3000`. Se si utilizza un'origine personalizzata (`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`), verificare che serva una pagina HTML con campi modulo — CSD necessita di elementi form per dimostrare le capacità di rilevamento.
</Aside>
...
| `F5XC_ORIGIN_IP` | Facoltativa | `192.0.2.1` | — |

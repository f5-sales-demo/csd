...
La Fase 1 distribuisce e valida l'infrastruttura CSD completa. Completare tutti i passaggi in ordine — ogni passaggio deve risultare PASS prima di procedere. Tornare all'[indice](/csd/demo/) per completare la Configurazione dell'Ambiente e la risoluzione delle variabili prima di eseguire questi comandi.
...
**Fase 1 completata.** Procedere alla [Fase 2 — Attacco](/csd/demo/phase-2-attack/) per eseguire la simulazione di attacco.

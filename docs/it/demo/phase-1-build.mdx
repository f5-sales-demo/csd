...
<Aside type="tip">
**Cache DNS negativa:** Se è stato interrogato il dominio prima che il record esistesse, il resolver ricorsivo potrebbe aver memorizzato nella cache la risposta `NXDOMAIN`. Verificare contro il nameserver autoritativo per escludere cache obsoleta:

...
| Segnale sintetico verso `www.httpbin.org` | `200` — segnale inviato | `200` — fetch ancora completata (CSD non intercetta fetch) |
| Segnale sintetico verso jsonplaceholder.typicode.com | `201` — segnale inviato | `201` — fetch ancora completata (CSD non intercetta fetch) |

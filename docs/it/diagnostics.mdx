...
| --- | --- |
| **PASS** &mdash; IP VIP restituito (ad es., `203.0.113.10`) | Il dominio si risolve nell'IP virtuale del LB |
...
<Aside type="tip">
**Cache DNS negativa:** Se il dominio ha precedentemente restituito `NXDOMAIN`, i resolver ricorsivi potrebbero aver memorizzato nella cache quel risultato. Verificare rispetto al nameserver autorevole per escludere cache obsolete: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com`.
</Aside>

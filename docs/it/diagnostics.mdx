...
Questi comandi sono l'**equivalente API** della [Procedura dettagliata della console CSD](/csd/it/csd-console/) — utilizzarli quando è necessario verificare dal terminale, automatizzare il monitoraggio o dimostrare le capacità di CSD senza l'interfaccia utente.

## Prerequisiti

Configurare le variabili di ambiente come descritto in [Automazione API &mdash; Configurazione dell'ambiente](/csd/it/demo/#environment-setup):
...
**Correzione:** [Automazione API &mdash; Passaggio 4: Configurare il DNS](/csd/it/demo/phase-1-build/#step-4-configure-dns)
...
**Correzione:** [Automazione API &mdash; Rilevare l'autorità DNS](/csd/it/demo/phase-1-build/#detect-dns-authority)
...
**Correzione:** [Automazione API &mdash; Opzione A: DNS gestito da F5 XC](/csd/it/demo/phase-1-build/#option-a-f5-xc-managed-dns)
...
**Correzione:** [LB bloccato in VIRTUAL_HOST_PENDING_A_RECORD](/csd/it/demo/#lb-stuck-in-virtual_host_pending_a_record)
...
**Correzione:** [Riferimento API &mdash; Abilitare CSD su un bilanciatore del carico](/csd/it/api-reference/#enable-csd-on-a-load-balancer)
...
**Correzione:** [Automazione API &mdash; Passaggio 2: Creare il pool di origine](/csd/it/demo/phase-1-build/#step-2-create-origin-pool)
...
| **FAIL** &mdash; era atteso un controllo di integrità ma l'array è vuoto | Il controllo di integrità non è stato trovato al momento della creazione &mdash; vedere [Controllo di integrità non collegato](/csd/it/demo/#healthcheck-not-linked-to-origin-pool) |
...
| **FAIL** &mdash; risposta `404` | Il controllo di integrità non esiste (potrebbe essere stato saltato &mdash; vedere [Fase 1 Passaggio 1](/csd/it/demo/phase-1-build/#step-1-create-healthcheck-optional)) |
...
| **FAIL** &mdash; gli elementi hanno campi `name` e `namespace` vuoti | Nessun dominio protetto registrato &mdash; vedere [Fase 1 Passaggio 6](/csd/it/demo/phase-1-build/#step-6-register-protected-domain) |
...
Questi comandi interrogano gli stessi dati visualizzati nel dashboard della [Console CSD](/csd/it/csd-console/), nell'elenco degli script, nei campi modulo e nelle viste di rete.
...
1. **Verificare la risoluzione DNS** &mdash; controllare che il dominio si risolva nel VIP del LB:
   ...
   dig +short xF5XC_DOMAINNAMEx A
   ```
   Se vuoto, il DNS non è configurato. Vedere [Automazione API &mdash; Passaggio 4](/csd/it/demo/phase-1-build/#step-4-configure-dns).
...
Per abilitare i record gestiti, aggiornare la configurazione della zona DNS impostando `allow_http_lb_managed_records: true`. Vedere [Automazione API &mdash; Opzione A: DNS gestito da F5 XC](/csd/it/demo/phase-1-build/#option-a-f5-xc-managed-dns) per la chiamata API.

### LB bloccato in VIRTUAL_HOST_PENDING_A_RECORD

Il bilanciatore del carico è in attesa di un record A DNS che punti al suo VIP. Vedere [LB bloccato in VIRTUAL_HOST_PENDING_A_RECORD](/csd/it/demo/#lb-stuck-in-virtual_host_pending_a_record) per i passaggi dettagliati di risoluzione.

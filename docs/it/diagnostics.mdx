...
| --- | --- |
| **PASS** &mdash; IP VIP restituito (ad es., `192.0.2.1`) | Il dominio si risolve nell'IP virtuale del LB |
...
<Aside type="tip">
**Cache DNS negativa:** Se il dominio ha precedentemente restituito `NXDOMAIN`, i resolver ricorsivi potrebbero aver memorizzato nella cache quel risultato. Verificare rispetto al nameserver autorevole per escludere cache obsolete: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com` oppure utilizzare un resolver pubblico come `@192.0.2.1`.
</Aside>

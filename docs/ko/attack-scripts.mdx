...
<Aside type="note">
유출 대상(`www.httpbin.org`, `jsonplaceholder.typicode.com`)은 CSD 네트워크 보기에 **표시되지 않습니다** — 스크립트 로드 소스 도메인만 표시됩니다. 이 시나리오의 주요 탐지 신호는 **폼 필드 읽기**입니다. 자세한 내용은 [탐지 경계](/csd/overview/#detection-boundaries)를 참조하십시오.
</Aside>

...
<Aside type="note">
CSD 데모의 기본 오리진은 `44.232.69.192:3000`의 Juice Shop 애플리케이션입니다. 커스텀 오리진(`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`)을 사용하는 경우, 폼 필드가 있는 HTML 페이지를 제공하는지 확인하십시오 — CSD는 탐지 기능을 시연하기 위해 폼 요소가 필요합니다.
</Aside>

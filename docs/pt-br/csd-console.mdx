...
Após executar a [simulação combinada](/csd/pt-br/trigger-detection/) e aplicar ações nos domínios de CDN injetados (`cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io`) pelo menu de ações, esses domínios também aparecerão na tabela com status **Encontrado &amp; Permitido** ou **Encontrado &amp; Mitigado**.
...
Para mitigação programática via API, consulte [Referência da API — Mitigação](/csd/pt-br/api-reference/#mitigation).

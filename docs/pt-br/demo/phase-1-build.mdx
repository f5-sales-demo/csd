...
<Aside type="tip">
**Cache DNS negativo:** Se você consultou o domínio antes de o registro existir, seu resolvedor recursivo pode ter armazenado em cache a resposta `NXDOMAIN`. Verifique no servidor de nomes autoritativo para descartar cache obsoleto:

...
A Fase 1 implanta e valida a infraestrutura CSD completa. Conclua todas as etapas em ordem — cada etapa deve receber PASS antes de prosseguir. Retorne ao [índice](/csd/pt-br/demo/) para concluir a Configuração do Ambiente e a resolução de variáveis antes de executar estes comandos.
...
Se DNS-1 retornar vazio após 60 segundos, consulte [Solução de Problemas &mdash; LB Stuck in VIRTUAL_HOST_PENDING_A_RECORD](/csd/pt-br/demo/#lb-stuck-in-virtual_host_pending_a_record).
...
**Fase 1 concluída.** Prossiga para a [Fase 2 — Ataque](/csd/pt-br/demo/phase-2-attack/) para executar a simulação de ataque.

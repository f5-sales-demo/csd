...
| Sinal sintético para `www.httpbin.org` | `200` — sinal enviado | `200` — fetch ainda é concluído (CSD não intercepta fetch) |
| Sinal sintético para jsonplaceholder.typicode.com | `201` — sinal enviado | `201` — fetch ainda é concluído (CSD não intercepta fetch) |

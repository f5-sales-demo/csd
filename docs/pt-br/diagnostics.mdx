...
| --- | --- |
| **PASSOU** &mdash; IP do VIP retornado (ex.: `203.0.113.10`) | Domínio resolve para o IP virtual do LB |
...
<Aside type="tip">
**Cache DNS negativo:** Se o domínio retornou `NXDOMAIN` anteriormente, os resolvedores recursivos podem ter armazenado esse resultado em cache. Verifique contra o servidor de nomes autoritativo para descartar cache obsoleto: `dig +short xF5XC_DOMAINNAMEx A @ns1.f5clouddns.com`.
</Aside>

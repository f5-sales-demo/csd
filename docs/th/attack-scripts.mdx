...
<Aside type="note">
เป้าหมายการส่งข้อมูลออก (`www.httpbin.org`, `jsonplaceholder.typicode.com`) จะ**ไม่**ปรากฏในมุมมอง CSD Network — จะแสดงเฉพาะโดเมนแหล่งที่มาของการโหลดสคริปต์เท่านั้น สัญญาณการตรวจจับหลักที่นี่คือ**การอ่านฟิลด์ฟอร์ม** ดูรายละเอียดที่ [ขอบเขตการตรวจจับ](/csd/th/overview/#detection-boundaries)
</Aside>

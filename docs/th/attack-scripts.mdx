...
description: >-
  ไลบรารีสคริปต์การจำลองการโจมตีที่สร้างไว้ล่วงหน้าและการเขียนสคริปต์แบบกำหนดเองสำหรับการทดสอบ
  CSD
sidebar:
  order: 9
...
หน้านี้จัดเตรียมไลบรารีสคริปต์การจำลองการโจมตีที่จัดระเบียบตามหมวดหมู่ สคริปต์แต่ละตัวเป็นฟังก์ชันที่ดำเนินการในตัวเอง (IIFE) ที่ออกแบบมาสำหรับวางลงใน Browser DevTools Console บนแอปพลิเคชันสาธารณะ ใช้สคริปต์เหล่านี้เพื่อฝึกความสามารถในการตรวจสอบ CSD ที่เฉพาะเจาะจงในระหว่างการสาธารณะต่อลูกค้า

<Aside type="caution">
สคริปต์เหล่านี้ใช้สำหรับ**การตรวจสอบก่อนการผลิตที่ได้รับอนุญาตเท่านั้น** เป้าหมายการรั่วไหลทั้งหมดเป็นจุดปลายทางสาธารณะที่ปลอดภัย (`www.httpbin.org`, `jsonplaceholder.typicode.com`) สคริปต์ที่ฉีดทั้งหมดโหลดไลบรารีที่ไม่เป็นอันตรายจาก CDN สาธารณะ
</Aside>

## กฎความปลอดภัย

สคริปต์ทั้งหมดในไลบรารีนี้ปฏิบัติตามข้อตกลงดังต่อไปนี้:

- **รูปแบบ IIFE** — ดำเนินการในตัวเองและวางลงใน DevTools Console
- **เป้าหมายการรั่วไหลที่ปลอดภัย** — `www.httpbin.org`, `jsonplaceholder.typicode.com`
- **แหล่งสคริปต์ที่ปลอดภัย** — `cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io` (โหลดไลบรารีที่ไม่เป็นอันตราย)
- **`mode: 'no-cors'`** ในการเรียก fetch ทั้งหมด
- **การประกาศ `var`** สำหรับความเข้ากันได้กับ console
- **ผลลัพธ์ Console** นำหน้าด้วย `[CSD Demo]` และแท็กหมวดหมู่
- **ไม่มีเพย์โหลดที่เป็นอันตรายจริง**

---

## 1. การลักครั้งแบบฟอร์ม และการเก็บเกี่ยวข้อมูลประจำตัว

### โปรแกรมลักข้อมูลประจำตัวของหน้าเข้าสู่ระบบ

**หน้าเป้าหมาย:** `/#/login` — ป้อนข้อมูลประจำตัวจำลองก่อนดำเนินการ

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม (อีเมล, รหัสผ่าน), เครือข่าย (fetch ไปยังโดเมนภายนอก)
...
**ตรวจสอบใน CSD console:**
- **Script List** — สคริปต์แอปพลิเคชัน (เช่น `main.js`) ถูกทำเครื่องหมายว่าเสี่ยงสูงสำหรับการอ่านฟิลด์อีเมลและรหัสผ่าน
- **Form Fields** — อีเมลและรหัสผ่านแสดงเป็นไวต่อการโจมตี (โดยระบบ)

### เครื่องเก็บเกี่ยวข้อมูลหน้าการลงทะเบียน

**หน้าเป้าหมาย:** `/#/register` — กรอกข้อมูลทั้งหมดก่อนดำเนินการ

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม (อีเมล, รหัสผ่าน, คำถามความปลอดภัย)
...
**ตรวจสอบใน CSD console:**
- **Form Fields** — ฟิลด์การลงทะเบียนปรากฏพร้อมการจำแนกความไวต่อการโจมตี
- **Script List** — สคริปต์ที่อ่านฟิลด์การลงทะเบียนถูกทำเครื่องหมายเพื่อการตรวจสอบ

---

## 2. การลักข้อมูลดิจิทัล

### โปรแกรมลักบัตรเครดิตของหน้าการชำระเงิน

**หน้าเป้าหมาย:** `/#/login` (การชำระเงิน Juice Shop ต้องใช้การตรวจสอบสิทธิ์ — ใช้หน้าเข้าสู่ระบบเพื่อสาธารณะเทคนิคการวางซ้อน)

**สัญญาณ CSD:** การฉีดสคริปต์ (แบบฟอร์มการวางซ้อน), การอ่านฟิลด์ฟอร์ม (ฟิลด์ดั้งเดิม)
...
**ตรวจสอบใน CSD console:**
- **Script List** — สคริปต์ถูกทำเครื่องหมายสำหรับการปรับแต่ง DOM และการอ่านฟิลด์
- **Form Fields** — ฟิลด์หน้าดั้งเดิมแสดงกิจกรรมการอ่าน

### โปรแกรมโหลดแบบเข้ารหัสหลายขั้น

**หน้าเป้าหมาย:** หน้าใดๆ บนเวบไซต์สาธารณะ

**สัญญาณ CSD:** การฉีดสคริปต์ (เพย์โหลดที่ถูกถอดรหัสสร้างแท็กสคริปต์ใหม่)
...
- **Network** — โดเมน `cdn.jsdelivr.net` แสดงอยู่

---

## 3. การฉีดโซ่อุปทาน และสคริปต์

### การฉีดจาก CDN หลายแห่ง

**หน้าเป้าหมาย:** หน้าใดๆ บนเวบไซต์สาธารณะ

**สัญญาณ CSD:** การฉีดสคริปต์ (แท็กสคริปต์บุคคลที่สาม 4 แท็ก), เครือข่าย (โดเมนใหม่ 4 โดเมน)
...
- **Network** — โดเมน CDN ทั้ง 4 โดเมนปรากฏในรายการ All Domains

### การจำลองการลักจาก Tag Manager

**หน้าเป้าหมาย:** หน้าใดๆ บนเวบไซต์สาธารณะ

**สัญญาณ CSD:** การฉีดสคริปต์ (สคริปต์การวิเคราะห์/tag manager จำลอง)
...
**ตรวจสอบใน CSD console:**
- **Script List** — สคริปต์ใหม่จาก `cdn.jsdelivr.net` พร้อมเส้นทาง `chart.js`
- **Form Fields** — หากรันบนหน้าที่มีแบบฟอร์ม กิจกรรมการอ่านฟิลด์เพิ่มขึ้น

---

## 4. ช่องทางการรั่วไหลข้อมูล

### การรั่วไหลข้อมูลผ่านหลายช่องทาง

**หน้าเป้าหมาย:** `/#/login` — ป้อนข้อมูลประจำตัวจำลองก่อนดำเนินการ

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม, เครือข่าย (fetch source domain)
...
<Aside type="note">
เป้าหมายการรั่วไหล (`www.httpbin.org`, `jsonplaceholder.typicode.com`) **จะไม่**ปรากฏใน CSD Network view — เฉพาะโดเมนแหล่งโหลดสคริปต์เท่านั้นที่แสดง สัญญาณการตรวจสอบหลักที่นี่คือ **การอ่านฟิลด์ฟอร์ม** ดูรายละเอียดใน [Detection Boundaries](/csd/overview/#detection-boundaries)
</Aside>

**ตรวจสอบใน CSD console:**
- **Form Fields** — ฟิลด์อีเมลและรหัสผ่านแสดงกิจกรรมการอ่าน
- **Script List** — สคริปต์แอปพลิเคชันถูกทำเครื่องหมายสำหรับการอ่านฟิลด์

### การรั่วไหลข้อมูลจากโดเมนจำนวนมาก

**หน้าเป้าหมาย:** `/#/login` — ป้อนข้อมูลประจำตัวจำลองก่อนดำเนินการ

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม, การฉีดสคริปต์ (แท็กสคริปต์จากโดเมนหลายแห่ง)
...
**ตรวจสอบใน CSD console:**
- **Script List** — รายการสคริปต์บุคคลที่สาม 5 รายการใหม่
- **Network** — โดเมน `cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io` แสดงอยู่
- **Form Fields** — ฟิลด์การเข้าสู่ระบบแสดงกิจกรรมการอ่าน

---

## 5. การปรับแต่ง DOM และการวางซ้อน

### การโจมตีแบบวางซ้อนแบบฟอร์ม

**หน้าเป้าหมาย:** `/#/login`

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม (อ่านฟิลด์ดั้งเดิมก่อนการวางซ้อน)
...
<Aside type="note">
CSD **ไม่**ติดตามฟิลด์ฟอร์มที่สร้างขึ้นแบบไดนามิก ส่วนประกอบ `input` ที่ฉีดของการวางซ้อนจะ**ไม่**ปรากฏใน CSD Form Fields view CSD ตรวจสอบการโจมตีนี้ผ่านการ**อ่านฟิลด์ดั้งเดิม**ที่เกิดขึ้นก่อนการวางซ้อน
</Aside>

**ตรวจสอบใน CSD console:**
- **Form Fields** — ฟิลด์อีเมลและรหัสผ่านดั้งเดิมแสดงกิจกรรมการอ่าน
- **Script List** — สคริปต์ถูกทำเครื่องหมายสำหรับการเข้าถึงฟิลด์

### การจำลองโปรแกรมบันทึกแป้นพิมพ์

**หน้าเป้าหมาย:** `/#/login`

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม (เข้าถึงองค์ประกอบ input เพื่อแนบตัวฟัง)
...
**ตรวจสอบใน CSD console:**
- **Form Fields** — ฟิลด์ input แสดงกิจกรรมการอ่านจากสคริปต์การตรวจสอบ
- **Script List** — สคริปต์ถูกทำเครื่องหมายสำหรับการเข้าถึงค่าฟิลด์ฟอร์ม

---

## 6. การทดสอบความเครียดแบบผสมผสาน

### สคริปต์การตรวจสอบสูงสุด

สคริปต์นี้รวมเวกเตอร์การโจมตีทั้งหมดไว้ในหนึ่ง IIFE — สคริปต์สาธารณะ "ultimate" ดำเนินการนี้เมื่อคุณต้องการทริกเกอร์สัญญาณการตรวจสอบ CSD ทั้งหมดในการดำเนินการเดียว

**หน้าเป้าหมาย:** `/#/login` — ป้อนข้อมูลประจำตัวจำลองก่อนดำเนินการ

**สัญญาณ CSD:** การอ่านฟิลด์ฟอร์ม, การฉีดสคริปต์ (โดเมน CDN 4 โดเมน), เครือข่าย (โดเมนใหม่ 4 โดเมน)
...
**ตรวจสอบใน CSD console (หลังจาก 5-10 นาที):**
- **Dashboard** — ตัวนับ Transactions Consumed เพิ่มขึ้น
- **Script List** — สคริปต์แอปพลิเคชันถูกทำเครื่องหมายว่า High Risk; สคริปต์บุคคลที่สาม 4 รายการใหม่จากโดเมน CDN
- **Form Fields** — อีเมลและรหัสผ่านจัดประเภทเป็น Sensitive (โดยระบบ) พร้อมกิจกรรมการอ่าน
- **Network** — โดเมน `cdn.jsdelivr.net`, `esm.sh`, `unpkg.com`, `ga.jspm.io` ปรากฏใน All Domains
- **Affected Users** — เซสชันของคุณปรากฏพร้อมที่อยู่ IP, ตำแหน่งทางภูมิศาสตร์, เบราว์เซอร์, ข้อมูลอุปกรณ์

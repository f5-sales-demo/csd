...
<Aside type="note">
Origin เริ่มต้นสำหรับการสาธิต CSD คือแอปพลิเคชัน Juice Shop ที่ `192.0.2.1:3000` หากคุณใช้ origin แบบกำหนดเอง (`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`) ให้ตรวจสอบว่ามันให้บริการหน้า HTML ที่มีฟิลด์ฟอร์ม — CSD ต้องการ form elements เพื่อสาธิตความสามารถในการตรวจจับ
</Aside>
...
| `xF5XC_ORIGIN_IPx` | `192.0.2.1` | IP ของเซิร์ฟเวอร์ origin |
...
| `xF5XC_ORIGIN_IPx` | IP ของเซิร์ฟเวอร์ origin | `192.0.2.1` |

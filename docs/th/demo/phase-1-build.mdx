...
Phase 1 ปรับใช้และตรวจสอบโครงสร้างพื้นฐาน CSD ทั้งหมด ดำเนินการทุกขั้นตอนตามลำดับ — แต่ละขั้นตอนต้องผ่าน (PASS) ก่อนดำเนินการต่อ กลับไปที่ [index](/csd/demo/) เพื่อทำการตั้งค่าสภาพแวดล้อมและการกำหนดค่าตัวแปรก่อนรันคำสั่งเหล่านี้
...
หาก DNS-1 ส่งคืนว่างหลังจาก 60 วินาที ดู [Troubleshooting &mdash; LB Stuck in VIRTUAL_HOST_PENDING_A_RECORD](/csd/demo/#lb-stuck-in-virtual_host_pending_a_record)
...
**Phase 1 เสร็จสมบูรณ์** ดำเนินต่อไปที่ [Phase 2 — Attack](/csd/demo/phase-2-attack/) เพื่อรันการจำลองการโจมตี

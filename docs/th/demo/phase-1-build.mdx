...
<Aside type="tip">
**Negative DNS cache:** หากคุณ query domain ก่อนที่ record จะมีอยู่ recursive resolver ของคุณอาจได้แคช `NXDOMAIN` response ตรวจสอบกับ authoritative nameserver เพื่อตัด stale cache ออก:

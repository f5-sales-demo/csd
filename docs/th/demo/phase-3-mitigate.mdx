...
| สัญญาณสังเคราะห์ไปที่ `www.httpbin.org` | `200` — ส่งสัญญาณแล้ว | `200` — fetch ยังคงเสร็จสิ้น (CSD ไม่สกัดกั้น fetch) |
| สัญญาณสังเคราะห์ไปที่ jsonplaceholder.typicode.com | `201` — ส่งสัญญาณแล้ว | `201` — fetch ยังคงเสร็จสิ้น (CSD ไม่สกัดกั้น fetch) |

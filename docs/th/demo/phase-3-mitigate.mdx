...
ผู้ปฏิบัติงานที่ไม่มีเครื่องมือ browser automation รันการจำลองแบบ manual โดยใช้ขั้นตอนเดียวกับ [เฟส 2 — ขั้นตอนที่ 8: การจำลองการโจมตี](/csd/demo/phase-2-attack/#step-8-attack-simulation):
...
4. วางและรัน Combined Detection Script จาก [การตรวจจับทริกเกอร์](/csd/trigger-detection/#run-the-combined-simulation-script)
...
ผู้ช่วย AI ที่มีเครื่องมือ browser automation รันการจำลองการโจมตีอีกครั้งด้วยโปรแกรมโดยใช้ **initScript ของเฟส 2 เดิมทุกประการ** (โค้ดที่เหมือนกันทุกประการใน [เฟส 2 — การรันอัตโนมัติด้วย AI](/csd/demo/phase-2-attack/#ai-automated-execution)) initScript บันทึก native `fetch` เพื่อหลีกเลี่ยงข้อผิดพลาด zone.js — ไม่ส่งผลต่อการลดผลกระทบ CSD เพราะ CSD ไม่สกัดกั้นการเรียก `fetch()`
...
ผู้ปฏิบัติงานที่ไม่มีเครื่องมือ browser automation รันการจำลองแบบ manual อีกครั้งโดยใช้ขั้นตอนเดียวกับ [เฟส 2 — ขั้นตอนที่ 8: การจำลองการโจมตี](/csd/demo/phase-2-attack/#step-8-attack-simulation):
...
**เฟส 3 เสร็จสมบูรณ์** ดำเนินการไปยัง [เฟส 4 — การรื้อถอน](/csd/demo/phase-4-teardown/) เมื่อคุณพร้อมที่จะลบ object การ deploy ทั้งหมด

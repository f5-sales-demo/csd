...
2. ป้อนข้อมูลรับรองทดสอบในฟิลด์แบบฟอร์ม — พิมพ์ `test@example.com` ในฟิลด์ **Email** และ `<DEMO_PASSWORD>` ในฟิลด์ **Password** (อย่ากดส่งแบบฟอร์ม)
...
| **สัญญาณเครือข่ายสังเคราะห์** | ส่งจำนวนฟิลด์และเครื่องหมายยืนยันการทิ้งผ่าน `fetch` โดยค่าฟิลด์ไม่เข้าสู่ payload | การเรียกเครือข่ายไปยังโดเมนภายนอก (หมายเหตุ: ปลายทาง fetch ปรากฏเป็นการโต้ตอบเครือข่ายของสคริปต์ ไม่ใช่ในมุมมองโดเมนเครือข่าย) |

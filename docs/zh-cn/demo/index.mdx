...
<Aside type="note">
CSD 演示的默认源是 Juice Shop 应用，位于 `192.0.2.1:3000`。如果您使用自定义源（`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`），请验证它提供一个具有表单字段的 HTML 页面 — CSD 需要表单元素来演示检测能力。
</Aside>
...
| `xF5XC_ORIGIN_IPx` | `192.0.2.1` | 源服务器 IP |
...
| `xF5XC_ORIGIN_IPx` | 源服务器 IP | `192.0.2.1` |

...
<Aside type="note">
CSD 示範的預設來源是 `44.232.69.192:3000` 上的 Juice Shop 應用程式。如果您使用自訂來源（`F5XC_ORIGIN_IP` / `F5XC_ORIGIN_PORT`），請確認它提供包含表單欄位的 HTML 頁面 — CSD 需要表單元素來展示偵測能力。
</Aside>
...
| `F5XC_ORIGIN_IP` | 選擇性 | `44.232.69.192` | — |
